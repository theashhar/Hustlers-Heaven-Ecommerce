...
export default function Signup() {
    const {withGoogle, error, setError, signup, user} = useContext(UserContext);
    useEffect(() => {
      if(user){
            ...
            <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
              <form className="space-y-6" onSubmit={(e)=>{
                ...
                if(password !== repeatPassword){
                    setError({
                        errorCode: "auth/passwords-not-match",
              ...
              <div className="mt-6">
                ...
                {error?.errorCode && <div className='mt-6 text-red-700'>
